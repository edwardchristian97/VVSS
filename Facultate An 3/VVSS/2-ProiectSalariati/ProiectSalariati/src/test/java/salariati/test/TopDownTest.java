...
public class TopDownTest {
    ...
    @Test
    public void testareIntegrarePA() {
        assertTrue(main.testareIntegrarePA(employeeRepository, controller));
    }

    @Test
    public void testareIntegrarePAB() {
        assertTrue(main.testareIntegrarePAB(employeeRepository, controller));
    }

    @Test
    public void testareIntegrareTopDown() {
